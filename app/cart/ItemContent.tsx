...
const ItemContent: React.FC<ItemContentProps> = ({ item }) => {
    ...
    return (
        <div className="grid grid-cols-5 text-xs md:text-sm gap-4 border-[2px] border-slate-200 py-4 pl-2 pr-4 items-center">
            <div className="col-span-2 justify-self-start flex gap-2 md:gap-4 ">
                <Link href={`/product/${item.id}`}>
                    <div className="relative w-[70px] h-[70px] aspect-sqaure">
            ...
            <div className="justify-self-center">
                <SetQuantity cartCounter={true} cartProduct={item} handleQtyIncrease={() => {handleQtyIncrease(item)}} handleQtyDecrease={() => {handleQtyDecrease(item)}} />
            </div>
